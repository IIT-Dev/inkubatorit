...
background-image: url('<?php echo base_url() ?>/img/overlay.png'), url('<?php echo $post->image ?>');
">
  <div class="container">
    <div class="row">
      <h1 class="title">
      ...
      <div class="meta">Di-posting pada <?php echo $post->time; ?></div> 
			<div class="meta">Oleh <?php echo $post->author; ?>, Category : <a href="<?php echo base_url('article/category').'/'.$post->kategori; ?>" ><?php echo $post->kategori; ?></a></div>
    </div>
  </div>
</div>

<div class="light-box post">
	<div class="container">
		<div class="row">
